...
var query_pb = createCommonjsModule(function (module, exports) {
  ...
  */
  ...
  proto.impresso.query.CollectionRecommenderParameter.deserializeBinaryFromReader = function (msg, reader) {
    while (reader.nextField()) {
      ...
      switch (field) {
        case 1:
          var value =
          /** @type {!proto.impresso.query.CollectionRecommenderParameter.RecommenderParameterId} */
          reader.readEnum();
          msg.setKey(value);
          break;
  ...
  proto.impresso.query.CollectionRecommender.deserializeBinaryFromReader = function (msg, reader) {
    while (reader.nextField()) {
      ...
      switch (field) {
        case 1:
          var value =
          /** @type {!proto.impresso.query.CollectionRecommender.RecommenderType} */
          reader.readEnum();
          msg.setType(value);
          break;
  ...
  proto.impresso.query.CollectionRecommender.prototype.getParametersList = function () {
    return (
      /** @type{!Array<!proto.impresso.query.CollectionRecommenderParameter>} */
  ...
  */
  ...
  proto.impresso.query.CollectionRecommendersSettings.prototype.getRecommendersList = function () {
    return (
      /** @type{!Array<!proto.impresso.query.CollectionRecommender>} */
...
var Filter = query_pb.Filter,
    ...
    CollectionRecommendersSettings = query_pb.CollectionRecommendersSettings,
    CollectionRecommender = query_pb.CollectionRecommender,
    CollectionRecommenderParameter = query_pb.CollectionRecommenderParameter;
...
function toFixedPointNumber(number) {
  var digits = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 2;
  if (number == null) return undefined;
  return parseFloat(number.toFixed(digits)) * Math.pow(10, digits);
}

function fromFixedPointNumber(number) {
  var digits = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 2;
  if (number == null) return undefined;
...
function collectionRecommenderSerializerConverter(obj) {
  return omitUndefinedAndEmptyLists$1(_objectSpread2({}, obj, {
    type: getEnumNumber$1(CollectionRecommender.RecommenderType, obj.type),
    weight: toFixedPointNumber(obj.weight),
    parameters: (obj.parameters || []).map(function (f) {
      return fromObject$1(CollectionRecommenderParameter, collectionRecommenderParameterSerializerConverter(f));
    })
  }));
}
...
function collectionRecommendersSettingsSerializerConverter(obj) {
  return omitUndefinedAndEmptyLists$1(_objectSpread2({}, obj, {
    recommenders: (obj.recommenders || []).map(function (f) {
      return fromObject$1(CollectionRecommender, collectionRecommenderSerializerConverter(f));
    })
  }));
}
...
var protobuf$1 = {
  ...
  collectionRecommendersSettings: {
    serialize: function serialize(obj) {
      return _serialize(CollectionRecommendersSettings, obj, collectionRecommendersSettingsSerializerConverter);
    },
    deserialize: function deserialize(base64String) {
      return _deserialize(CollectionRecommendersSettings, base64String, collectionRecommendersSettingsDeserializerConverter);
    }
  }
};
